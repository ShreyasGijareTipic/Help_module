  ...
  return (
    ...
    <CContainer className="container-md invoice-content">
      ...
      <div className="d-flex flex-row mb-3">
        ...
        <div className="ml-3">
          <p>Shree Samarth fertilizer</p>
          <p>Nasik-pune Road, At.Po,keshavnager </p>
          <p>Tal. Haveli, Dist. pune, 411015</p>
          <p>Phone: 97**24**23</p>
        </div>
      </div>
          ...
          <table className="table table-bordered border-black">
            <thead  className='table-success border-black' >
              <tr >
                ...
                <th className='text-center'>Quantity(Ton's)</th>
      ...
      <div className="d-flex  border p-3 border-black">
        ...
        <div className='flex-fill'>
          <div className="d-flex flex-column  align-items-center text-center ">
            <h6>E-SIGNATURE MR.RAJARAM GHORPADE</h6>
